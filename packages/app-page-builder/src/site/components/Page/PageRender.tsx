...
import { PageDataSourcesProvider } from "@webiny/app-page-builder/render/contexts/PageDataSourcesContext";
...
function PageRender({ loading, data, error }: PageRenderProps) {
    ...
    return (
        <PageDataSourcesProvider dataSources={data.dataSources}>
